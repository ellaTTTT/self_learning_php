<?php 
  ...
  $pageImage = 'images/pexels-lisa-fotios-1126728.jpg';
...
?>
    ...
    <p>
      ...
      why we are committed to use only natural, locally-sourced produce,
      free-range meats, and sustainably caught seafood.
      Our culinary team works closely with local farmers and artisans
      to ensure that the ingredients we use aren't merely fresh but
    ...
    <p>
      ...
      Every herb, spice, and vegetavle is chosen with care,
      accentuating the natural flavors and textures of our dishes.
      It is this focus on natural, high-quality ingredients that transforms
      dining at Culinary Cove into more than just a meal-it becomes a
      journey into a world of pure, unadulterated taste.
    </p>
